...
namespace AP.F5.LTM.Discovery.classes
{
    public class ProfileClientSSL
    {
        ...
        public ProfileClientSSL(SyncFailoverGroup dg, string PartitionName, string FullName, string Description, string CertFileNames)
        {
            // Get ShortName
            ...
            ManagementPackClass mpc_Profile = SCOM.GetManagementPackClass("AP.F5.LTM.ProfileClientSSL");
